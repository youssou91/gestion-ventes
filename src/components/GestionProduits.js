...
const GestionProduits = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-1 p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">Gestion des Produits</h2>

      <button
        onClick={openModal}
        className="bg-blue-600 text-white font-bold py-2 px-4 rounded-lg mb-3 hover:bg-blue-700"
      >
        Ajouter un produit
      </button>
